...
(L<http://haslayout.net/>, L<http://zoffix.com/>,
L<http://min-power-book.com/>)

=head1 BUGS

Please report any bugs or feature requests to C<bug-app-zofcms-plugin-boolsettingsmanager at rt.cpan.org>, or through
the web interface at L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=App-ZofCMS-Plugin-BoolSettingsManager>.  I will be notified, and then you'll
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc App::ZofCMS::Plugin::BoolSettingsManager
...
L<http://rt.cpan.org/NoAuth/Bugs.html?Dist=App-ZofCMS-Plugin-BoolSettingsManager>

=item * AnnoCPAN: Annotated CPAN documentation

L<http://annocpan.org/dist/App-ZofCMS-Plugin-BoolSettingsManager>

=item * CPAN Ratings

L<http://cpanratings.perl.org/d/App-ZofCMS-Plugin-BoolSettingsManager>

=item * Search CPAN

L<http://search.cpan.org/dist/App-ZofCMS-Plugin-BoolSettingsManager/>
